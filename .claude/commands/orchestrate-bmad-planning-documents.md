...
Load and execute the workflow at @_bmad/my-custom-bmad/workflows/orchestrate-planning-documents/workflow.md

Follow the INITIALIZATION SEQUENCE in workflow.md:

1. Load config from @_bmad/my-custom-bmad/workflows/orchestrate-planning-documents/config.yaml
...
4. Execute @_bmad/my-custom-bmad/workflows/orchestrate-planning-documents/steps-c/step-01-init.md to begin
