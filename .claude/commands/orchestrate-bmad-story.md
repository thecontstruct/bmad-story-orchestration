...
Load and execute the workflow at @_bmad/my-custom-bmad/workflows/orchestrate-story/workflow.md

Follow the INITIALIZATION SEQUENCE in workflow.md:

1. Load config from @_bmad/my-custom-bmad/workflows/orchestrate-story/config.yaml
2. Load bmm config from @_bmad/bmm/config.yaml for implementation_artifacts
3. Execute @_bmad/my-custom-bmad/workflows/orchestrate-story/steps/step-01-init.md to begin
